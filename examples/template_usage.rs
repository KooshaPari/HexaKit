//! Quickstart example for HexaKit.
//!
//! Run with:
...
fn main() {
    ...
    println!("This binary was generated from the HexaKit template.");
    println!();
    println!("To generate your own crate from this template:");
    println!("  cargo install cargo-generate");
    println!("  cargo generate --git https://github.com/KooshaPari/HexaKit");
}
