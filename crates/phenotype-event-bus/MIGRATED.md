# Migration: phenotype-event-bus → phenoShared

**Date:** 2026-06-17  
**Disposition step:** HexaKit DISPOSITION #19 — Wave E absorption stub  
...
1. Depend on phenotype-event-bus from phenoShared (path or git pin), not HexaKit.
2. See DOMAIN_ROLES and disposition-index row id **19**.
