# Comprehensive xDD Methodologies Reference

This document consolidates the complete xDD (extreme/extended Development Disciplines) methodology corpus from phenoXdd, organized as a reference guide for the phenotype organization.

## Overview

**150+ methodologies** covering software engineering best practices, organized into 12 categories:
- Core Development Disciplines (TDD, BDD, ATDD, SDD, FDD, etc.)
- Architecture Principles (Hexagonal, Clean, Onion, CQRS, Event Sourcing, Microservices, etc.)
- Design Principles (SOLID, DRY, KISS, POLA, LoD, etc.)
- Testing Methodologies (Test Pyramid, Property-Based, Mutation, Fuzz, Performance, etc.)
- Documentation Methodologies (Living Docs, ADRs, C4 Model, API Docs, etc.)
- Process & Workflow (CI/CD, Trunk-Based, GitFlow, GitHub Flow, Agile, Scrum, Kanban, etc.)
- Code Quality Practices (Code Review, Pair Programming, Linting, Static Analysis, etc.)
- Collaboration & Team Practices (Mob Programming, Pair Rotations, SRE, DevOps, etc.)
- Operational Practices (Infrastructure as Code, GitOps, Observability, Feature Flags, Canary Releases, etc.)
- Advanced Topics (DDD, Event Storming, User Story Mapping, Impact Mapping, etc.)
- Domain-Driven Design Extensions (Bounded Contexts, Aggregates, Domain Events, Anti-Corruption Layer, etc.)
- Platform-Specific Practices (Rust, Go, TypeScript, Python, Kubernetes, GraphQL, gRPC, etc.)
...
Reference E2E testing configuration from phenoXdd:
...
- [Property Testing](/reference/property-testing/)
- [Contract Testing](/reference/contract-testing/)
- [Mutation Testing](/reference/mutation-testing/)
- [SpecDD](/reference/specdd/)
- [Architecture](/reference/architecture/)

## Contributing

This is a living document. Submit PRs to:
1. Add new methodologies or improve descriptions
2. Include references and practical examples
3. Cross-link related patterns and practices

## License

MIT (inherited from phenoXdd)
