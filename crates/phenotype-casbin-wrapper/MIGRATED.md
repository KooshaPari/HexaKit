...
**Date:** 2026-06-17  
**Disposition step:** HexaKit DISPOSITION #34 — Wave C absorption stub  
...
1. Depend on phenotype-casbin-wrapper from Authvault (path or git pin), not HexaKit.
2. See DOMAIN_ROLES and disposition-index row id **34**.
