...
shortly before that repository was archived on 2026-06-19. It preserves the **hexagon /
...
cp -r /path/to/HexaKit/templates/hexagon/. .
```
...
- [`KooshaPari/HexaKit`](../..) — this repository's root
- ADR-017 — *"Deprecate Apisync; absorb template patterns into HexaKit"*

## Origin: pheno-cargo-template

<!-- Merged from /tmp/pct-verify2/templates/hexagonal/README.md on 2026-06-20 -->
